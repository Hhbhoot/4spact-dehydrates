    ...
    products: [
      {
        ...
        description:
          'Manufacturing Process : White pepper is made from fully ripe pepper berries. The berries are soaked in water for several days, a process known as retting, to soften and decompose the outer layer of the fruit. This outer skin is then removed by rubbing or trampling, leaving the pale inner core, which is then dried and ground into a fine powder.',
        image: wp,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : Black pepper is made from the dried, unripe berries of the pepper plant. After harvesting, the green berries are blanched in hot water and then dried in the sun. As they dry, they shrivel and turn black, forming the peppercorns. These dried peppercorns are then ground into a powder.',
        image: bp,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : Fenugreek powder is made from the dried seeds of the fenugreek plant. The seeds are cleaned to remove any impurities, such as stones or sand. They may be lightly roasted to enhance their flavor and aroma before being ground into a fine powder. This powder is then stored in an airtight container.',
        image: fen,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : Fennel seeds are cleaned and then dry-roasted in a pan until they are fragrant and slightly golden. This process enhances their flavor and aroma. Once cooled, the roasted seeds are ground into a fine powder using a spice grinder or mortar and pestle.',
        image: fennel,
        features: [
      ...
      },
      {
        ...
        name: 'Cumin Powder',
        description:
          '• ​Manufacturing Process: Cumin seeds are cleaned and then dry-roasted to a light brown color to bring out their warm, earthy aroma. The roasted seeds are then ground into a fine powder. This powder is typically more potent than powder made from unroasted seeds.',
        image: cum,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : Fresh green chilies are washed and dried completely. They are then chopped and dehydrated, either in a dehydrator or under direct sunlight, until they become brittle. Once dry, they are ground into a fine powder.',
        image: gc,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : Ripe red chilies are harvested and dried in the sun. The drying process causes them to shrivel and turn a deep red color. The dried chilies are then ground into a fine powder, and the fineness and color can vary depending on the variety of chili used.',
        image: rc,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : The rhizomes of the turmeric plant are harvested, boiled, and then dried in the sun or in a mechanical dryer. The dried rhizomes are then ground into a fine, bright yellow-orange powder.',
        image: turp,
        features: [
      ...
      },
      {
        ...
        name: 'Ajwain Powder',
        description:
          'Manufacturing Process : Ajwain seeds are cleaned, dehydrated, and then ground into a fine powder.',
        image: ajw,
        features: [
      ...
      },
      {
        ...
        name: 'Clove Powder',
        description:
          ' Manufacturing Process : Clove buds are harvested from the clove tree before they flower. The buds are then dried, typically in the sun, until they turn a dark brown color. Finally, the dried buds are ground into a fine powder.',
        image: clove,
        features: [
    ...
    products: [
      {
        ...
        name: 'Moringa Powder',
        description:
          ' ​Manufacturing Process: Moringa powder is produced from the leaves of the moringa tree. The leaves are harvested, carefully washed, and then dried at a low temperature to preserve their nutrient content. After drying, the leaves are stripped from the stems and ground into a fine, bright green powder. The powder is then packaged in airtight containers, as it can lose its potency and color if exposed to air and light.',
        image: moringa,
        features: [
      ...
      },
      {
        ...
        name: 'Tulsi Powder',
        description:
          'Manufacturing Process : The process involves harvesting mature tulsi leaves, which are then thoroughly dried to remove all moisture. The dried leaves are then ground into a fine powder and sieved to ensure a uniform texture, before being packaged in airtight containers to maintain freshness and potency.',
        image: tulsi,
        features: [
      ...
      },
      {
        ...
        name: 'Amla Powder',
        description:
          '​Amla fruits are selected, cleaned, and then sliced before being completely dried. The dried slices are then ground into a fine powder and sieved to achieve a smooth consistency, and finally packaged to preserve their nutritional content.',
        image: amla,
        features: [
      ...
      },
      {
        ...
        name: 'Neem Powder',
        description:
          ' ​Manufacturing Process: Neem leaves are harvested, cleaned, and dried away from direct sunlight. Once fully dehydrated, they are ground into a fine powder.',
        image: p4,
        features: [
    ...
    products: [
      {
        ...
        description:
          'We manufacturer dehydrated Garlic as per customer requirements of fresh Garlic are washed, trimmed, cut and dehydrated by passing hot air dried closed continuous system are export to worldwide.',
        image: dga,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : Tomato Powder is one of the most widely used ingredients in the Food and Beverage industry, having applications in a variety of products.',
        image: dsdt,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : We are well known as the trusted supplier of best quality Dehydrated Red Beet Powder. These offered beets are most commonly used in confectionery, soups, dairy products, sauces, deserts, ice creams and soft drinks. These are processed by making fresh red beet roots powder at our ultramodern infrastructure facility under the guidance of veteran professionals. This Dehydrated Beet Root Powder is easy to digest and hygienically packed .',
        image: db,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : Carrots are washed, peeled, and cut into desired shapes (e.g., slices, cubes, or shreds). They are then blanched in hot water for a short time to preserve their color and nutrients. Afterward, they are dried using a dehydrator or oven until they are completely moisture-free and brittle.',
        image: dec,
        features: [
      ...
      },
      {
        ...
        description:
          'Manufacturing Process : Cucumbers are washed, peeled (if desired), and sliced into thin, uniform pieces. The slices are then laid out on dehydrator trays and dried at a low temperature for several hours until all moisture is removed, leaving them crisp and lightweight.',
        image: dc,
        features: [
      ...
      },
      {
        ...
        name: 'Fried Garlic',
        description:
          'Manufacturing Process : Garlic cloves are peeled and thinly sliced. The slices are then fried in a neutral oil at a moderate temperature until they are golden brown and crispy. The fried garlic is then strained from the oil and cooled, becoming a crunchy and flavorful topping.',
        image: fg,
        features: [
      ...
      },
      {
        ...
        name: 'Fried Onion ',
        description:
          'Manufacturing Process: Onions are sliced, battered, and then deep-fried until golden and crispy.',
        image: fo,
        features: [
    ...
    products: [
      {
        ...
        description:
          ' Dried red chilies are soaked in hot water to soften. The softened chilies, along with other ingredients like vinegar, salt, and garlic, are then blended or ground into a smooth paste. The paste may be cooked to enhance its flavor and extend its shelf life.',
        image: rcp,
        features: [
      ...
      },
      {
        ...
        name: 'Carrot Paste',
        description:
          'Carrots are washed, peeled, and cooked until very soft. They are then pureed in a blender or food processor to form a smooth paste. The paste may be seasoned with salt or other spices and then packaged or frozen for later use.',
        image: cp,
        features: [
      ...
      },
      {
        ...
        name: 'Beetroot Paste',
        description:
          ' Beetroots are washed, trimmed, and cooked until tender. The cooked beetroots are then peeled and pureed in a blender or food processor until a smooth, thick consistency is achieved. The puree can be used immediately or stored for later.',
        image: bep,
        features: [
      ...
      },
      {
        ...
        name: 'Tomato Paste',
        description:
          'Ripe tomatoes are cooked down to a thick pulp to remove moisture. The pulp is then sieved to remove the skins and seeds. The remaining liquid is further cooked until it is reduced to a very thick, concentrated paste.',
        image: tp,
        features: [
      ...
      },
      {
        ...
        name: 'Ginger Paste',
        description:
          'Fresh ginger rhizomes are washed, peeled, and chopped. The chopped ginger is then ground into a smooth paste, often with a small amount of water or oil to aid the process. Some manufacturers add a preservative like citric acid or salt to extend its shelf life.',
        image: gip,
        features: [
      ...
      },
      {
        ...
        name: 'Garlic Paste',
        description:
          'Garlic cloves are peeled and processed in a blender or food processor with a small amount of oil or water until a smooth, uniform paste is formed. Salt or an acidic agent may be added as a preservative.',
        image: gp,
        features: [
