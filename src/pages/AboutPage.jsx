      ...
      >
        ...
        <section className="relative w-full h-[80vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center text-white px-6 max-w-3xl">
            ...
            >
              Leading manufacturer of high-quality dehydrated products and
              premium spices exported across the globe.
            </motion.p>
            <motion.a
              href="#contact"
              whileHover={{
        ...
        <section className="py-16 md:py-24 bg-gradient-to-r from-orange-50 to-green-50">
          <div className="max-w-5xl mx-auto px-6 text-center space-y-6">
            <p className="text-lg md:text-xl leading-relaxed">
              <strong>4spact Dehydrates</strong> is a leading company
              specializing in the manufacturing of high-quality dehydrated
              products and the export of a wide range of premium spices. We are
              committed to providing our clients with exceptional products that
              meet global standards of quality and freshness.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                colors, rich flavors, and nutrition of every product, making
                them ideal for global kitchens and industries.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
